...
### Create Labels & Move Emails from Inbox

```bash
# Organize emails by sender into dedicated folders
...
python skills/gmail_label_organizer.py --create-label "Steven Hage" --from "shage@mutualmortgage.com"

# Create more labels as needed
python skills/gmail_label_organizer.py --create-label "Clients" --from "clients@domain.com"
python skills/gmail_label_organizer.py --create-label "Team" --from "team@company.com"
```

**What it does:**
- ✅ Creates a new folder/label in Gmail (if doesn't exist)
- ✅ Finds ALL emails from that sender
- ✅ Moves them out of Inbox into the label
...
- **SESSION_2026-02-25_GMAIL_ORGANIZATION.md** - Latest session work
