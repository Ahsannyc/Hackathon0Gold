        ...
        try:
            ...
            for f in files:
                try:
                    ...
                    self.error_handler.write_error(e, context="file_summarization", extra={"file": f.name})
                    print(f"  ✗ Failed to summarize {f.name}")
                    continue
            ...
            self.error_handler.write_error(e, context="workflow_execution")
