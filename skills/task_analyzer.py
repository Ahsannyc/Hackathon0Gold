...
class TaskAnalyzer:
    def __init__(self, project_root):
        ...
        self.error_handler = SkillErrorHandler("task_analyzer", ".")
    ...
    def check_approval_needed(self, content):
        ...
        for check_name, check_func in rules.items():
            try:
                ...
                self.error_handler.write_error(e, context="approval_check", extra={"check": check_name})
...
"""
    ...
    def execute(self):
        ...
        try:
            ...
            self.error_handler.write_error(e, context="task_analysis_workflow", extra={"step": "analysis"})
